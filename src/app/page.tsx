  ...
  return (
    <main className="whm-home-shell" style={{ padding: 48, maxWidth: 900, margin: "0 auto" }}>
      ...
      <section className="whm-home-copy">
        <div className="whm-home-hero">
          <p className="whm-home-title whm-home-kicker">
            Welcome to Witching Hour Music and Art Collective.
          </p>

          <p>
            Witching Hour is a signal — a convergence of sound, symbol, and
            system. We work at the intersection of music, art, technology, and
            ritual, building structures that speak both to the machine and the
            human.
          </p>
